 ...
 */
class ReflectionPropertyWithExternalAdapterTest extends PHPUnit_Framework_TestCase {
    ...
    protected function setUp() {
        ReflectionProperty::setReflectionAdapterClass(OriginReflectionProperty::class);
