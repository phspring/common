...
class Composer {
    public static function addAnnotationNamespaces( \Composer\Script\Event $event){
        ...
        $annotationNamespaces['Symfony\Component\Validator'] = dirname(dirname(dirname(dirname((new \ReflectionClass('Symfony\Component\Validator\Validator'))->getFileName()))));
